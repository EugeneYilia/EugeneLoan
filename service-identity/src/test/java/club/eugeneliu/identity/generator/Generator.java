...
public class Generator {
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("/home/eugeneliu/EEugeneSoft/EugeneLoan/service-identity/src/main/java");
        ...
        strategyConfig.setInclude(new String[]{"user_required_info"});

        autoGenerator.setStrategy(strategyConfig);

        PackageConfig packageConfig = new PackageConfig();
        packageConfig.setParent("club.eugeneliu.identity");//设置生成类class的包package
